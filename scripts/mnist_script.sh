...
python eval/run_drd.py \
  ...
  --student_kwargs '{"epochs": 3500, "batch_size": 256, "lr": 0.001, "lambda_d": 20000, "warmup": 0, "eta_min1":1e-8, "eta_min2": 1.587436e-16, "T_max": 2100, "save_model": true, "activation": "SELU", "bottleneck_activation": null, "save_model_path": "/shared/share_mala/irchang/drd/models/mnist_pca2.pt"}' \
  --seeds '[0]' \
  --device "cuda:1" 
